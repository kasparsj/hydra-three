...
4. Implemented: make orbit modifier configurable  
   Files: `src/three/HydraOrbitControls.js:92`, `src/lib/mixins.js:10`, `README.md:138`, `scripts/smoke/browser-non-global-smoke.mjs:91`  
...
| 2    | Orbit controls default to `Alt` (mitigated by `controls.modifier`)                 | `src/three/HydraOrbitControls.js:837`; `src/three/HydraOrbitControls.js:1038`; `src/lib/mixins.js:10`           | `examples/box.js:1`; `site/playground/examples.js:49`; `site/playground/examples.js:812` | 2 x 3 = 6    |
